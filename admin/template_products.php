...
<div>
  ...
  <div class="countdownMarquee">
    ...
    <label class="countdown" >"Free Standard Shipping on any Php1000.00 up Purchase."</label>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#">Jovita Belleza Manila</a>
...
<div class="jumbotron container">
  ...
  <a class="btn btn-dark btn-lg" id="sign" href="#" role="button">Sign In / Sign Up</a>
</div>
